...
# Valid Invites
  ...
  Scenario: Create a valid invite from student to professor
    ...
    And There is a proposal by "student1" titled "TREBALL FINAL DE GRAU" with description "Detailed description of the project for a final degree proposal" and timing "timing" and specialty "specialty" and kind "kindd"
  ...
  Scenario: Create a valid invite from professor to student
    ...
    And There is a proposal by "professor1" titled "TREBALL FINAL DE GRAU" with description "Detailed description of the project for a final degree proposal" and timing "timing" and specialty "specialty" and kind "kindd"
  ...
  Scenario: Create a valid invite from external to student
    ...
    And There is a proposal by "external1" titled "TREBALL FINAL DE GRAU" with description "Detailed description of the project for a final degree proposal" and timing "timing" and specialty "specialty" and kind "kindd"
...
# Other Scenarios
  ...
  Scenario: Attempt to create an invite without being logged in
    ...
    And There is a proposal by "student1" titled "TREBALL FINAL DE GRAU" with description "Detailed description of the project for a final degree proposal" and timing "timing" and specialty "specialty" and kind "kindd"
    When "claudia" creates an invite to user "student2" for proposal "TREBALL FINAL DE GRAU" with status "PENDING" and date "2025-04-06T12:00:00Z"
    Then The response code is 500
